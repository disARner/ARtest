...
function HelloWorldSceneAR() {
  ...
  function _onInitialized(state, reason) {
    if (state == ViroConstants.TRACKING_NORMAL) {
      setText('Move around with your camera')
      ...
      <ViroARScene onTrackingUpdated={_onInitialized.bind(this)} >
        ...
        {/* <ViroARPlane minHeight={.5} minWidth={.5} alignment={"Horizontal"}> */}
          <ViroNode position={[0,-1,0]} dragType="FixedToWorld" onDrag={()=>{}} >
              ...
              {/* shirt */}
              {/* <Viro3DObject
                  source={require('./res/Shirt_Dolman3/shirt_dolmanv1_39kpolys.obj')}
                  resources={[require('./res/Shirt_Dolman3/shirt_dolmanv1_39kpolys.mtl'), require('./res/Shirt_Dolman3/01.jpg')]}
                  position={[-1, -3, -3]}
                  scale={[.02, .02, .02]}
                  // rotation={[90, 180, 180]}
                  animation={{name: "rotate", run: true, loop: true}}
              ...
              {/* <Viro3DObject
                  ...
                  resources={[require('./res/polo_pants/13648_Polo_Pants_v2_L3.mtl'), require('./res/polo_pants/13648PoloPants_cloth_diffuse.jpg')]}
                  position={[-1, 0, -2]}
                  scale={[.02, .02, .02]}
                  rotation={[90, 180, 180]}
                  animation={{name: "rotate", run: true, loop: true}}
